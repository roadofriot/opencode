...
- `MindSparQ AI` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `MindSparQ AI` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `MindSparQ AI` inside commands, URLs, package names, or code literals
