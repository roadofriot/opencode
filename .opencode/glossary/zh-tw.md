...
- `MindSparQ AI` (preserve casing in prose; keep `opencode` only when it is part of commands, package names, paths, or code)
- `MindSparQ AI Zen`
- `MindSparQ AI CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `opencode` in prose when referring to the product name; use `MindSparQ AI`
