...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips mindsparq-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-mindsparq-directory"]).toBeUndefined()
      expect(forwarded["x-mindsparq-workspace"]).toBeUndefined()
