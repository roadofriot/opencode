...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/mindsparq.git")).toEqual({ owner: "sst", repo: "mindsparq" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/mindsparq")).toEqual({ owner: "sst", repo: "mindsparq" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/mindsparq.git")).toEqual({ owner: "sst", repo: "mindsparq" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/mindsparq")).toEqual({ owner: "sst", repo: "mindsparq" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/mindsparq.git")).toEqual({ owner: "sst", repo: "mindsparq" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/mindsparq")).toEqual({ owner: "sst", repo: "mindsparq" })
})
