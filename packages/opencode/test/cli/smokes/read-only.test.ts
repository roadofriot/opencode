...
describe("mindsparq read-only commands (smoke)", () => {
  ...
  cliIt.live(
    ...
    ({ mindsparq }) =>
      Effect.gen(function* () {
        const r = yield* mindsparq.spawn(["mcp", "list"])
        mindsparq.expectExit(r, 0, "mcp list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ mindsparq }) =>
      Effect.gen(function* () {
        const r = yield* mindsparq.spawn(["providers", "list"])
        mindsparq.expectExit(r, 0, "providers list")
  ...
  cliIt.live(
    ...
    ({ mindsparq }) =>
      Effect.gen(function* () {
        const r = yield* mindsparq.spawn(["models"])
        mindsparq.expectExit(r, 0, "models")
  ...
  cliIt.live(
    ...
    ({ mindsparq }) =>
      Effect.gen(function* () {
        const r = yield* mindsparq.spawn(["agent", "list"])
        mindsparq.expectExit(r, 0, "agent list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ mindsparq }) =>
      Effect.gen(function* () {
        const r = yield* mindsparq.spawn(["session", "list"])
        mindsparq.expectExit(r, 0, "session list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ mindsparq }) =>
      Effect.gen(function* () {
        const r = yield* mindsparq.spawn(["stats"])
        mindsparq.expectExit(r, 0, "stats")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ mindsparq }) =>
      Effect.gen(function* () {
        const r = yield* mindsparq.spawn(["db", "path"])
        mindsparq.expectExit(r, 0, "db path")
