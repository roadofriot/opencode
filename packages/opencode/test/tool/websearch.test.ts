...
describe("websearch provider", () => {
  ...
  test("is only enabled for mindsparq or explicit websearch provider flags", () => {
    expect(webSearchEnabled(ProviderV2.ID.mindsparq, { exa: false, parallel: false })).toBe(true)
