...
>()("@mindsparq/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@mindsparq/ExperimentalHttpApiWorkspaceRouting") {}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-mindsparq-directory"] || process.cwd()
}
