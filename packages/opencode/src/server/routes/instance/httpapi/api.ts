...
export const RootHttpApi = HttpApi.make("mindsparq-root")
...
export const InstanceHttpApi = HttpApi.make("mindsparq-instance")
...
export const MindsparqHttpApi = HttpApi.make("mindsparq")
