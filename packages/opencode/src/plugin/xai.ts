...
export function buildAuthorizeUrl(
  ...
  // clients. `referrer=mindsparq` lets xAI attribute mindsparq-originated
...
<html>
  <head>
    <title>MindSparQ AI - xAI Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>MindSparQ AI - xAI Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
async function startOAuthServer(): Promise<{ port: number; redirectUri: string }> {
  ...
  await new Promise<void>((resolve, reject) => {
    ...
    server.listen(OAUTH_PORT, OAUTH_HOST, () => {
      ...
      // behavior and crash the entire mindsparq process. Matches the silent-
