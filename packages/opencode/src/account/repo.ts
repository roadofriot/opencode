...
import { AccountStateTable, AccountTable } from "@mindsparq-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@mindsparq/AccountRepo") {}
