import type { JsonSchema, LLMRequest, ProviderMetadata } from "@mindsparq-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@mindsparq-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @mindsparq-ai/llm request objects from mindsparq's session/AI SDK-shaped data.
  return LLM.request({
