...
import { buildPrompt } from "@mindsparq-ai/core/session/compaction"
...
export class Service extends Context.Service<Service, Interface>()("@mindsparq/SessionCompaction") {}
