...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@mindsparq-ai/core/session/prompt"
...
export class Service extends Context.Service<Service, Interface>()("@mindsparq/SessionPrompt") {}
