...
import type { Event, GlobalEvent, OpencodeClient } from "@mindsparq-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@mindsparq/RunStreamTransport") {}
