...
import { normalizePromptContent } from "@mindsparq-ai/tui/editor"
...
import { OPENCODE_BASE_MODE, useBindings } from "@mindsparq-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close MindSparQ AI" } satisfies SlashOption,
    ]
