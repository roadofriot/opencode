...
import { createOpencodeClient } from "@mindsparq-ai/sdk/v2/client"
import { ServerAuth } from "@mindsparq-ai/server/auth"
...
export class Service extends Context.Service<Service, Interface>()("@mindsparq/cli/Daemon") {}
