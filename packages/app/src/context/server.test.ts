  ...
  test("moves an existing canonical web bucket into local scope", () => {
    expect(
      migrateCanonicalLocalServerState(
        {
          list: [],
          projects: { "https://mindsparq.example.com": [{ worktree: "/remote", expanded: true }] },
          lastProject: { "https://mindsparq.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://mindsparq.example.com"),
      ),
    ).toEqual({
      list: [],
      ...
      migrateCanonicalLocalServerState(
        {
          projects: {
            ...
            "https://mindsparq.example.com": [
              { worktree: "/local", expanded: true },
              { worktree: "/remote", expanded: true },
            ],
          },
          lastProject: { local: "/local", "https://mindsparq.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://mindsparq.example.com"),
      ),
    ).toEqual({
