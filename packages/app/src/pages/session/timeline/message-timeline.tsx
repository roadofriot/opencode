...
import { Accordion } from "@mindsparq-ai/ui/accordion"
...
import {
  ...
  partDefaultOpen,
  type UserActions,
} from "@mindsparq-ai/ui/message-part"
import { DiffChanges } from "@mindsparq-ai/ui/diff-changes"
...
import { InlineInput } from "@mindsparq-ai/ui/inline-input"
import { Spinner } from "@mindsparq-ai/ui/spinner"
import { SessionRetry } from "@mindsparq-ai/ui/session-retry"
import { ScrollView } from "@mindsparq-ai/ui/scroll-view"
import { StickyAccordionHeader } from "@mindsparq-ai/ui/sticky-accordion-header"
import { TextField } from "@mindsparq-ai/ui/text-field"
import { TextReveal } from "@mindsparq-ai/ui/text-reveal"
import { TextShimmer } from "@mindsparq-ai/ui/text-shimmer"
import type {
  AssistantMessage,
  ...
  ToolPart,
  UserMessage,
} from "@mindsparq-ai/sdk/v2"
import { showToast } from "@/utils/toast"
import { getDirectory, getFilename } from "@mindsparq-ai/core/util/path"
import { Popover as KobaltePopover } from "@kobalte/core/popover"
import { normalize } from "@mindsparq-ai/ui/session-diff"
import { useFileComponent } from "@mindsparq-ai/ui/context/file"
        ...
        >
          ...
          <Show when={timelineRows().length > 0}>
            <div
              ...
              aria-hidden="true"
              class="h-24 absolute top-0 left-0 w-full"
              style={{ transform: `translateY(${virtualizer.getTotalSize() - 96}px)` }}
            />
          </Show>
        </div>
      </ScrollView>
