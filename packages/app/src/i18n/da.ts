export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af MindSparq AI",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i MindSparq AI.",
  ...
  "provider.connect.opencodeZen.line1":
    "MindSparq AI Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i MindSparq AI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i MindSparq AI.",
  ...
  "dialog.server.description": "Skift hvilken MindSparq AI-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af MindSparq AI ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til MindSparq AI-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, MindSparq AI understøtter ikke MCP-godkendelse endnu.',
  ...
  "session.header.openFileIn": "Åbn fil i",
  ...
  "sidebar.gettingStarted.line1": "MindSparq AI inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør MindSparq AI-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for MindSparq AI",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan MindSparq AI ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om MindSparq AI følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan MindSparq AI er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når MindSparq AI starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af MindSparq AI.",
