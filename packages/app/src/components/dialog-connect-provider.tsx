import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@mindsparq-ai/sdk/v2/client"
...
import { List, type ListRef } from "@mindsparq-ai/ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "mindsparq"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.mindsparqZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.mindsparqZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.mindsparqZen.visit.prefix")}
                <Link href="https://mindsparq.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.mindsparqZen.visit.link")}
                </Link>
                {language.t("provider.connect.mindsparqZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
