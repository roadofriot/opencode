...
beforeAll(async () => {
  ...
  mock.module("@mindsparq-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@mindsparq-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@mindsparq-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@mindsparq-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
