...
export type WslJob =
  ...
  | { kind: "probe-mindsparq"; distro: string; startedAt: number }
  | { kind: "install-mindsparq"; distro: string; startedAt: number }
...
export type WslServersState = {
  ...
  mindsparqChecks: Record<string, WslOpencodeCheck>
