...
export function ErrorComponent(props: { error: Error; reset: () => void; mode?: "dark" | "light" }) {
  ...
  const issueURL = new URL("https://github.com/anomalyco/mindsparq/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("mindsparq-version", InstallationVersion)
