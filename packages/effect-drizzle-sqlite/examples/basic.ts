...
class Database extends Context.Service<Database, DatabaseShape>()("@mindsparq/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@mindsparq/example/UserStore") {
