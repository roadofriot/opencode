...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@mindsparq-ai/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@mindsparq-ai/llm/route"
import { OpenAI } from "@mindsparq-ai/llm/providers"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-mindsparq-tutorial": "1" },
    query: { debug: "1" },
  },
})
