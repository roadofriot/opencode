export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من MindSparq",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من MindSparq، هل ترغب في تثبيته وإعادة تشغيله؟",
