...
const cspValue = [
  ...
  "connect-src 'self' data: https://*.supabase.co https://*.supabase.in wss://*.supabase.co https://api.github.com https://*.firebaseio.com https://*.googleapis.com https://cdn.jsdelivr.net http://127.0.0.1:* ws://127.0.0.1:* wss://127.0.0.1:*",
