...
import type { DesktopTheme } from "@mindsparq-ai/ui/theme/types"
...
const cspValue = [
  ...
  "connect-src 'self' data: https://*.supabase.co https://*.supabase.in wss://*.supabase.co https://api.github.com https://*.firebaseio.com https://*.googleapis.com https://cdn.jsdelivr.net https://api.openai.com https://api.groq.com https://api-inference.huggingface.co https://huggingface.co https://*.huggingface.co http://127.0.0.1:* ws://127.0.0.1:* wss://127.0.0.1:*",
...
function wireWindowRecovery(win: BrowserWindow, name: string) {
  ...
  win.webContents.on("render-process-gone", (_event, details) => {
    ...
    void show(
      "MindSparQ AI window terminated unexpectedly",
  ...
  win.on("unresponsive", () => {
    ...
    sampler.start()
    void show("MindSparQ AI is not responding", "You can relaunch the app, open the logs, or keep waiting.", true)
  })
  win.on("responsive", () => {
