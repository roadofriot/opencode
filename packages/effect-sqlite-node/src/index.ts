...
export const TypeId: TypeId = "~@mindsparq-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@mindsparq-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@mindsparq-ai/effect-sqlite-node/NodeSqliteClient")
