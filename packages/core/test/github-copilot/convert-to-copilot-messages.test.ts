import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@mindsparq-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
