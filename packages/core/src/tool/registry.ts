...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@mindsparq-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@mindsparq/v2/ToolRegistry") {}
