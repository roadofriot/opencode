export * as Mindsparq from "./opencode"
...
/** Intentional public native API for Effect applications embedding Mindsparq. */
export class Service extends Context.Service<Service, Interface>()("@mindsparq-ai/public/Mindsparq") {}
...
>()("@mindsparq-ai/public/Mindsparq/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("Mindsparq.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("Mindsparq.sessions.switchModel")(function* (input) {
...
// TODO: Add Mindsparq.create(...) as the Promise facade over the same native API semantics.
