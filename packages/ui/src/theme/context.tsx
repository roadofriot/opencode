...
const STORAGE_KEYS = {
  THEME_ID: "mindsparq-theme-id",
  COLOR_SCHEME: "mindsparq-color-scheme",
  THEME_CSS_LIGHT: "mindsparq-theme-css-light",
  THEME_CSS_DARK: "mindsparq-theme-css-dark",
} as const
