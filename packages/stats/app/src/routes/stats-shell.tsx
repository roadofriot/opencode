import mindsparqWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/mindsparq",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star MindSparQ AI on GitHub",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "mindsparq:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://mindsparq.ai/">
            <strong>Try MindSparQ AI</strong>
          </a>
          <button
...
function MindsparqMark() {
  return (
    <svg data-slot="mindsparq-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://mindsparq.ai/legal/terms-of-service", label: "Terms of service" },
    { href: "https://mindsparq.ai/legal/privacy-policy", label: "Privacy policy" },
  ]
  const connect = [
    { href: "mailto:hello@mindsparq.ai", label: "Contact us" },
    { href: "https://mindsparq.ai/discord", label: "Community" },
    { href: "https://x.com/mindsparq", label: "X" },
    githubLink,
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://mindsparq.ai" aria-label="MindSparQ AI home">
          <MindsparqMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={mindsparqWordmarkDark} alt="MindSparQ AI" />
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">MindSparQ AI Newsletter</h2>
            <p>
