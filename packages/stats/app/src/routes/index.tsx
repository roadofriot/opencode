...
const statsHomeTitle = "AI Model Usage Rankings | MindSparQ AI Data"
const statsHomeDescription =
  "Explore MindSparQ AI Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns."
const statsHomeFallbackUrl = "https://mindsparq.ai/data/"
...
function getStatsHomeUrl(base: string, requestUrl: string) {
  ...
  if (url.hostname === "stats.mindsparq.ai") return "https://mindsparq.ai/data/"
  if (url.hostname === "stats.dev.mindsparq.ai") return "https://dev.mindsparq.ai/data/"
  return url.toString()
}
  ...
  return (
    <section id="top-models" data-section="top-models">
      <h2 data-slot="top-models-title">
        <strong>Top models.</strong> <span>Usage of models across MindSparQ AI Go.</span>
      </h2>
      <Show
