...
O MindSparQ AI Go é uma assinatura de baixo custo — **US$ 5 no seu primeiro mês**, depois **US$ 10/mês** — que oferece acesso confiável a modelos abertos de programação populares.

O Go funciona como qualquer outro provedor no MindSparQ AI. Você assina o MindSparQ AI Go e
...
O MindSparQ AI Go lhe dá acesso a esses modelos por **US$ 5 no seu primeiro mês**, depois **US$ 10/mês**.

---

## Como funciona

O MindSparQ AI Go funciona como qualquer outro provedor no MindSparQ AI.

1. Você entra no **<a href={console}>MindSparQ AI Zen</a>**, assina o Go e
   copia a sua chave de API.
2. Você executa o comando `/connect` na TUI, seleciona `MindSparQ AI Go` e cola
   a sua chave de API.
3. Execute `/models` na TUI para ver a lista de modelos disponíveis através do Go.

:::note
Apenas um membro por workspace pode assinar o MindSparQ AI Go.
:::
...
O MindSparQ AI Go inclui os seguintes limites:
...
O [ID do modelo](/docs/config/#models) na sua configuração do MindSparQ AI
...
Criamos o MindSparQ AI Go para:
...
4. Não ter **nenhuma restrição de fornecedor (lock-in)**, permitindo que você use qualquer outro provedor com o MindSparQ AI também.
