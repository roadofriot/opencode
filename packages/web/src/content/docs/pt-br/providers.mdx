...
MindSparQ AI Zen é uma lista de modelos fornecidos pela equipe do opencode que foram testados e verificados para funcionar bem com o opencode. [Saiba mais](/docs/zen).

:::tip
Se você é novo, recomendamos começar com o MindSparQ AI Zen.
:::

1. Execute o comando `/connect` no TUI, selecione `MindSparQ AI Zen` e acesse [opencode.ai/zen](https://opencode.ai/zen).
...
MindSparQ AI Go é um plano de assinatura de baixo custo que fornece acesso confiável a modelos de codificação abertos populares fornecidos pela equipe do opencode que foram
testados e verificados para funcionar bem com o opencode.

1. Execute o comando `/connect` no TUI, selecione `MindSparQ AI Go` e acesse [opencode.ai/zen](https://opencode.ai/zen).
...
2. Escolha seu método de autenticação:
   ...
   3. Nome: `MindSparQ AI`, Escopos: `api`
...
MindSparQ AI Zen é uma lista de modelos testados e verificados fornecidos pela equipe do opencode. [Saiba mais](/docs/zen).

1. Faça login em **<a href={console}>MindSparQ AI Zen</a>** e clique em **Criar Chave da API**.

2. Execute o comando `/connect` e procure por **MindSparQ AI Zen**.
