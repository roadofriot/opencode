...
MindSparQ AI Zen, MindSparQ AI ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, MindSparQ AI'daki diğer sağlayıcılar gibi çalışır. MindSparQ AI Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve MindSparQ AI kullanmak için buna ihtiyacınız yoktur.
...
:::tip
MindSparQ AI ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
MindSparQ AI Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

MindSparQ AI Zen, MindSparQ AI'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>MindSparQ AI Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, MindSparQ AI Zen'i seçin ve API anahtarınızı yapıştırın.
...
MindSparQ AI yapılandırmanızdaki [model id](/docs/config/#models) `opencode/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `opencode/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için MindSparQ AI'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için MindSparQ AI'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için MindSparQ AI'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için MindSparQ AI'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için MindSparQ AI'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
MindSparQ AI Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca MindSparQ AI ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
