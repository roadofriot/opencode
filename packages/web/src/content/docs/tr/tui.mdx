---
title: TUI
description: MindSparQ AI terminal kullanıcı arayüzünü kullanma.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MindSparQ AI, projelerinizde LLM ile çalışmak için etkileşimli bir terminal arayüzü (TUI) sunar.

MindSparQ AI'u çalıştırdığınızda mevcut dizin için TUI başlar.
...
MindSparQ AI TUI kullanırken `/` ve ardından komut adını yazarak hızlı eylemler çalıştırabilirsiniz. Örneğin:
...
MindSparQ AI'a bir sağlayıcı ekler. Mevcut sağlayıcıları seçip API anahtarları eklemenizi sağlar.
...
MindSparQ AI'dan çıkar. _Takma adlar_: `/quit`, `/q`
...
- `leader_timeout` - MindSparQ AI'un leader key sonrasında ne kadar bekleyeceğini kontrol eder. Varsayılan değer `2000`.
