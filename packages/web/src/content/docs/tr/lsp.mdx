...
description: MindSparQ AI, LSP sunucularınızla bütünleşir.
---

MindSparQ AI, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

MindSparQ AI, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
