---
title: ACP podrška
description: Koristite MindSparQ AI u bilo kojem uređivaču kompatibilnom sa ACP.
---

MindSparQ AI podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili MindSparQ AI putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `opencode acp`.

Naredba pokreće MindSparQ AI kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "MindSparQ AI" agenta u AI Chat agent selektoru.
...
Da koristite MindSparQ AI kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi MindSparQ AI kao ACP chat agenta.
...
MindSparQ AI radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj MindSparQ AI konfiguraciji
