...
Postoje dvije vrste agenata u MindSparQ AI: primarni agenti i podagenti.
...
MindSparQ AI dolazi sa dva ugrađena primarna agenta, **Build** i **Plan**. Pogledat ćemo ih u nastavku.
...
MindSparQ AI dolazi sa tri ugrađena subagenta, **General**, **Explore** i **Scout**. Ovo ćemo pogledati u nastavku.

---

## Ugrađeni

MindSparQ AI dolazi sa dva ugrađena primarna agenta i tri ugrađena subagenta.
...
Agent samo za čitanje za istraživanje eksterne dokumentacije i zavisnosti. Koristite ga kada trebate klonirati repozitorij zavisnosti u MindSparQ AI-ov upravljani cache, pregledati izvorni kod biblioteke ili uporediti lokalni kod sa upstream implementacijama bez mijenjanja vašeg radnog prostora.
...
Ako temperatura nije navedena, MindSparQ AI koristi standardne postavke specifične za model; obično 0 za većinu modela, 0.55 za Qwen modele.
...
Ova putanja je relativna u odnosu na mjesto gdje se nalazi konfiguracijski fajl. Dakle, ovo radi i za globalnu MindSparQ AI konfiguraciju i za konfiguraciju specifične za projekat.
...
ID modela u vašoj MindSparQ AI konfiguraciji koristi format `provider/model-id`. Na primjer, ako koristite [MindSparQ AI Zen](/docs/zen), koristili biste `opencode/gpt-5.1-codex` za GPT 5.1 Codex.
