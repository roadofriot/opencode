---
title: LSP serveri
description: MindSparQ AI se integriše sa vašim LSP serverima.
---

MindSparQ AI se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

MindSparQ AI dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
