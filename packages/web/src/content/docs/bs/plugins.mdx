---
title: Dodaci
description: Napišite vlastite dodatke za proširenje MindSparQ AI.
---

Dodaci vam omogućavaju da proširite MindSparQ AI spajanjem na različite događaje i prilagođavanjem ponašanja. Možete kreirati dodatke za dodavanje novih funkcija, integraciju sa eksternim uslugama ili izmenu zadanog ponašanja MindSparQ AI.
...
MindSparQ AI pokreće `bun install` pri pokretanju da ih instalira. Vaši dodaci i alati ih zatim mogu uvesti.
...
Evo nekoliko primjera dodataka koje možete koristiti za proširenje MindSparQ AI.
