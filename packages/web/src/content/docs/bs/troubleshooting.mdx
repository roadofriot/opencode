...
Da biste otklonili probleme s MindSparQ AI, počnite provjeravanjem dnevnika i lokalnih podataka koje pohranjuje na disku.
...
MindSparQ AI pohranjuje podatke o sesiji i druge podatke aplikacije na disku na:
...
MindSparQ AI Desktop pokreće lokalni MindSparQ AI server (`opencode-cli` sidecar) u pozadini. Većina problema je uzrokovana nedostatkom dodatka, oštećenom keš memorijom ili lošim postavkama servera.
...
- samo za macOS: `MindSparQ AI` meni -> **Ponovo učitaj Webview** (pomaže ako je korisnički interfejs prazan/zamrznut).
...
MindSparQ AI također može učitati lokalne dodatke s diska. Privremeno ih maknite s puta (ili preimenujte folder) i ponovo pokrenite desktop aplikaciju:
...
Ako onemogućavanje dodataka ne pomogne (ili se instalacija dodatka zaglavila), obrišite keš memoriju kako bi ga MindSparQ AI mogao ponovo izgraditi.

1. Potpuno zatvorite MindSparQ AI Desktop.
...
3. Ponovo pokrenite MindSparQ AI Desktop.

---

### Rješavanje problema sa vezom na serveru

MindSparQ AI Desktop može ili pokrenuti svoj lokalni server (podrazumevano) ili se povezati na URL servera koji ste konfigurisali.
...
Na Windows-u, MindSparQ AI Desktop zahtijeva Microsoft Edge **WebView2 Runtime**. Ako se aplikacija otvori u praznom prozoru ili se ne pokrene, instalirajte/ažurirajte WebView2 i pokušajte ponovo.

---

### Windows: Opšti problemi sa performansama

Ako imate spore performanse, probleme s pristupom datotekama ili probleme s terminalom na Windows-u, pokušajte koristiti [WSL (Windows podsistem za Linux)](/docs/windows-wsl). WSL pruža Linux okruženje koje radi neprimetnije sa MindSparQ AI karakteristikama.

---

### Obavještenja se ne prikazuju

MindSparQ AI Desktop prikazuje sistemska obavještenja samo kada:

- obavještenja su omogućena za MindSparQ AI u postavkama vašeg OS-a, i
...
1. Zatvorite MindSparQ AI Desktop.
2. Pronađite i izbrišite ove datoteke (oni žive u direktoriju podataka MindSparQ AI Desktop aplikacije):
...
Ako imate problema s MindSparQ AI:
...
Ako naiđete na greške API poziva, to može biti zbog zastarjelih paketa dobavljača. MindSparQ AI dinamički instalira pakete dobavljača (OpenAI, Anthropic, Google, itd.) po potrebi i kešira ih lokalno.
...
2. Ponovo pokrenite MindSparQ AI da ponovo instalirate najnovije pakete dobavljača

Ovo će prisiliti MindSparQ AI da preuzme najnovije verzije paketa dobavljača, što često rješava probleme kompatibilnosti s parametrima modela i promjenama API-ja.
...
MindSparQ AI će otkriti da li koristite Wayland i preferirate `wl-clipboard`, u suprotnom će pokušati pronaći alate međuspremnika po redoslijedu: `xclip` i `xsel`.
