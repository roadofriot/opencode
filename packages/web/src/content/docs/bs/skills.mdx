...
Agent skills omogucavaju MindSparQ AI da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
MindSparQ AI pretrazuje ove lokacije:
...
Za projektne lokalne putanje, MindSparQ AI ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
MindSparQ AI navodi dostupne skills u opisu `skill` alata.
