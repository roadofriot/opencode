---
title: Provajderi
description: Korištenje bilo kojeg LLM provajdera u MindSparQ AI.
---

import config from "../../../../config.mjs"
export const console = config.console

MindSparQ AI koristi [AI SDK](https://ai-sdk.dev/) i [Models.dev](https://models.dev) za podršku **75+ LLM provajdera** i podržava pokretanje lokalnih modela.

Za dodavanje provajdera potrebno je:

1. Dodajte API ključeve za provajdera koristeći naredbu `/connect`.
2. Konfigurirajte dobavljača u vašoj MindSparQ AI konfiguraciji.
...
Možete prilagoditi dobavljače putem odjeljka `provider` u vašem MindSparQ AI
config.
...
MindSparQ AI Zen je lista modela koje je obezbedio MindSparQ AI tim koji su bili
testirano i potvrđeno da dobro radi sa MindSparQ AI. [Saznajte više](/docs/zen).

:::tip
Ako ste novi, preporučujemo da počnete sa MindSparQ AI Zen.
:::
...
Radi kao i svaki drugi provajder u MindSparQ AI i potpuno je opcionalan za korištenje.

---

## MindSparQ AI Go

MindSparQ AI Go je jeftin plan pretplate koji pruža pouzdan pristup popularnim modelima otvorenog kodiranja koje pruža MindSparQ AI tim i koji su testirani i verificirani da dobro rade s MindSparQ AI-om.

1. Pokrenite naredbu `/connect` u TUI-u, odaberite `MindSparQ AI Go` i idite na [opencode.ai/auth](https://opencode.ai/zen).
...
Da biste koristili Amazon Bedrock s MindSparQ AI:
...
:::info
[Anthropic] (https://anthropic.com) službeno ne podržava korištenje vaše Claude Pro/Max pretplate u MindSparQ AI.
:::
...
3.  Naziv: `MindSparQ AI`, opseg: `api`
...
MindSparQ AI koristi mali model za neke AI zadatke kao što je generiranje naslova sesije.
Podrazumevano je konfigurisan da koristi gpt-5-nano, a hostuje ga Zen. Da zaključate MindSparQ AI
...
Za korištenje Google Vertex AI s MindSparQ AI:
...
Heliconeova funkcija [Sessions](https://docs.helicone.ai/features/sessions) vam omogućava da grupišete povezane LLM zahtjeve zajedno. Koristite dodatak [opencode-helicone-session](https://github.com/H2Shami/opencode-helicone-session) da automatski prijavite svaki MindSparQ AI razgovor kao sesiju u Helicone-u.
...
Dodatak ubacuje zaglavlja `Helicone-Session-Id` i `Helicone-Session-Name` u vaše zahtjeve. Na stranici Helicone Sessions, vidjet ćete svaki MindSparQ AI razgovor naveden kao zasebna sesija.
...
:::tip
Ollama se može automatski konfigurirati za MindSparQ AI. Pogledajte [Ollama integracijske dokumente](https://docs.ollama.com/integrations/opencode) za detalje.
:::
...
Da biste koristili Ollama Cloud s MindSparQ AI:
...
3. Kopirajte API ključ za korištenje u MindSparQ AI.
...
6. **Važno**: Prije upotrebe modela oblaka u MindSparQ AI, morate lokalno povući informacije o modelu:
...
MindSparQ AI Zen je lista testiranih i verifikovanih modela koju je obezbedio MindSparQ AI tim. [Saznajte više](/docs/zen).

1. Prijavite se na **<a href={console}>MindSparQ AI Zen</a>** i kliknite na **Kreiraj API ključ**.

2. Pokrenite naredbu `/connect` i potražite **MindSparQ AI Zen**.

```txt
   /connect
```

3. Unesite svoj MindSparQ AI API ključ.
...
Polja `limit` omogućavaju MindSparQ AI da shvati koliko vam je konteksta ostalo. Standardni dobavljači ih automatski preuzimaju sa models.dev.
...
2. Za prilagođene provajdere, provjerite MindSparQ AI konfiguraciju i:
