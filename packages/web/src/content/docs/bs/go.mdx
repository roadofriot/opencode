...
MindSparQ AI Go je povoljna pretplata — **$5 za vaš prvi mjesec**, a zatim **$10/mjesečno** — koja vam pruža pouzdan pristup popularnim otvorenim modelima za programiranje.

Go radi kao bilo koji drugi provajder u MindSparQ AI-u. Pretplatite se na MindSparQ AI Go i
dobijete svoj API ključ. On je **potpuno opcionalan** i ne morate ga koristiti da
biste koristili MindSparQ AI.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade sa MindSparQ AI-om.
:::
...
MindSparQ AI Go vam daje pristup ovim modelima za **$5 za vaš prvi mjesec**, a zatim **$10/mjesečno**.

---

## Kako funkcioniše

MindSparQ AI Go radi kao bilo koji drugi provajder u MindSparQ AI-u.

1. Prijavite se na **<a href={console}>MindSparQ AI Zen</a>**, pretplatite se na Go i
   kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI-ju, odaberite `MindSparQ AI Go` i zalijepite
   svoj API ključ.
3. Pokrenite `/models` u TUI-ju da vidite listu modela dostupnih kroz Go.

:::note
Samo jedan član po radnom prostoru (workspace) može se pretplatiti na MindSparQ AI Go.
:::
...
MindSparQ AI Go uključuje sljedeća ograničenja:
...
[Model id](/docs/config/#models) u vašoj MindSparQ AI konfiguraciji
...
Napravili smo MindSparQ AI Go da bismo:
...
4. Osigurali da **nema zaključavanja (no lock-in)**, omogućavajući vam da uz MindSparQ AI koristite i bilo kojeg drugog provajdera.
