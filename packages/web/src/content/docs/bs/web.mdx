---
title: Web
description: Korišćenje MindSparQ AI u vašem pretraživaču.
---

MindSparQ AI može raditi kao web aplikacija u vašem pretraživaču, pružajući isto moćno iskustvo AI kodiranja bez potrebe za terminalom.

![MindSparQ AI Web - Nova sesija](../../../assets/web/web-homepage-new-session.png)
...
Ovo pokreće lokalni server na `127.0.0.1` sa nasumičnim dostupnim portom i automatski otvara MindSparQ AI u vašem podrazumevanom pretraživaču.
...
MindSparQ AI podrazumevano bira dostupni port. Možete odrediti port:
...
Podrazumevano, server se vezuje za `127.0.0.1` (samo lokalni host). Da biste MindSparQ AI učinili dostupnim na vašoj mreži:

```bash
opencode web --hostname 0.0.0.0
```

Kada koristite `0.0.0.0`, MindSparQ AI će prikazati i lokalne i mrežne adrese:
...
Jednom pokrenut, web sučelje pruža pristup vašim MindSparQ AI sesijama.

### Sesije

Pregledajte i upravljajte svojim sesijama sa početne stranice. Možete vidjeti aktivne sesije i započeti nove.

![MindSparQ AI Web - aktivna sesija](../../../assets/web/web-homepage-active-session.png)

### Status servera

Kliknite "Pogledajte servere" da vidite povezane servere i njihov status.

![MindSparQ AI Web - Vidi servere](../../../assets/web/web-homepage-see-servers.png)
