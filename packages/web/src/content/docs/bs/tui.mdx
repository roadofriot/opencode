---
title: TUI
description: Korištenje korisničkog interfejsa MindSparQ AI terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MindSparQ AI pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje MindSparQ AI pokreće TUI za trenutni direktorij.
...
Kada koristite MindSparQ AI TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u MindSparQ AI. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz MindSparQ AI. _Aliases_: `/quit`, `/q`
...
- `leader_timeout` - Kontroliše koliko dugo MindSparQ AI čeka nakon leader key. Podrazumijevano je `2000`.
