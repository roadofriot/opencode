---
title: Zen
description: Kurirana lista modela koje nudi MindSparQ AI.
---
...
MindSparQ AI Zen je lista testiranih i provjerenih modela koje pruža MindSparQ AI tim.

Zen radi kao i svaki drugi provajder u MindSparQ AI. Prijavite se na MindSparQ AI Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili MindSparQ AI.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s MindSparQ AI.
:::
...
MindSparQ AI Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

MindSparQ AI Zen radi kao i svaki drugi provajder u MindSparQ AI.

1. Prijavite se na **<a href={console}>MindSparQ AI Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite MindSparQ AI Zen i zalijepite svoj API ključ.
...
[model id](/docs/config/#models) u vašoj MindSparQ AI konfiguraciji koristi format
...
- DeepSeek V4 Flash Free je dostupan na MindSparQ AI ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- MiMo-V2.5 Free je dostupan na MindSparQ AI ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- North Mini Code Free je dostupan na MindSparQ AI ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Ultra Free je dostupan na MindSparQ AI ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na MindSparQ AI ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
MindSparQ AI Zen smo napravili da:
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u MindSparQ AI.
