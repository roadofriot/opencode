---
title: Share
description: Share your MindSparQ AI conversations.
---

MindSparQ AI's share feature allows you to create public links to your MindSparQ AI conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, MindSparQ AI:
...
MindSparQ AI supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, MindSparQ AI uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
