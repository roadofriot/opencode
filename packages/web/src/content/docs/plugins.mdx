---
title: Plugins
description: Write your own plugins to extend MindSparQ AI.
---

Plugins allow you to extend MindSparQ AI by hooking into various events and customizing behavior. You can create plugins to add new features, integrate with external services, or modify MindSparQ AI's default behavior.
...
MindSparQ AI runs `bun install` at startup to install these. Your plugins and tools can then import them.
...
:::note
If you’re using the MindSparQ AI desktop app, it can send system notifications automatically when a response is ready or when a session errors.
:::
