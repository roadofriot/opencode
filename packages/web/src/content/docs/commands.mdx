...
You can add custom commands through the MindSparQ AI config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your MindSparQ AI [config](/docs/config):
