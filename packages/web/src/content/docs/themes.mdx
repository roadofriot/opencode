...
With MindSparQ AI you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, MindSparQ AI uses our own `opencode` theme.
...
MindSparQ AI comes with several built-in themes.
...
- Want MindSparQ AI to match their terminal's appearance
...
MindSparQ AI supports a flexible JSON-based theme system that allows users to create and customize themes easily.
