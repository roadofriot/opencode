---
title: Partager
description: Partagez vos conversations MindSparQ AI.
---

La fonctionnalité de partage de MindSparQ AI vous permet de créer des liens publics vers vos conversations MindSparQ AI, afin que vous puissiez collaborer avec vos coéquipiers ou obtenir de l'aide d'autres personnes.
...
Lorsque vous partagez une conversation, MindSparQ AI :
...
MindSparQ AI prend en charge trois modes de partage qui contrôlent la manière dont les conversations sont partagées :

---

### Manuel (par défaut)

Par défaut, MindSparQ AI utilise le mode de partage manuel. Les sessions ne sont pas partagées automatiquement, mais vous pouvez les partager manuellement à l'aide de la commande `/share` :
