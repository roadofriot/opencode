...
Les compétences d'agent permettent à MindSparQ AI de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
MindSparQ AI recherche ces emplacements :
...
Pour les chemins locaux du projet, MindSparQ AI remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
MindSparQ AI répertorie les compétences disponibles dans la description de l'outil `skill`.
