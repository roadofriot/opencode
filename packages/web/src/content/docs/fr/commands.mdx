...
Vous pouvez ajouter des commandes personnalisées via la configuration MindSparQ AI ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre MindSparQ AI [config](/docs/config) :
