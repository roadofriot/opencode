---
title: TUI
description: Utilisation de l’interface utilisateur du terminal MindSparQ AI.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MindSparQ AI fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de MindSparQ AI démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le MindSparQ AI TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à MindSparQ AI. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
Quittez MindSparQ AI. *Alias* : `/quit`, `/q`
...
- `leader_timeout` - Contrôle la durée pendant laquelle MindSparQ AI attend après la leader key. Valeur par défaut : `2000`.
