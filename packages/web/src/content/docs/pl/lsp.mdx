---
title: Serwery LSP
description: MindSparQ AI integruje się z serwerami LSP.
---

MindSparQ AI może integrować się z serwerami Language Server Protocol (LSP), aby używać diagnostyki jako informacji zwrotnej dla agenta.

---

## Wbudowane

MindSparQ AI posiada kilka wbudowanych serwerów LSP dla następujących języków:
...
Gdy LSP jest włączony i MindSparQ AI otwiera plik:
...
Możesz włączać i dostosowywać serwery LSP poprzez sekcję `lsp` w konfiguracji MindSparQ AI.
