---
title: ACP
description: Używanie MindSparQ AI z protokołem Agent Client Protocol (ACP).
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MindSparQ AI obsługuje [Agent Client Protocol](https://agentclientprotocol.com) (ACP), który umożliwia korzystanie z MindSparQ AI bezpośrednio w edytorach i środowiskach IDE.
...
Aby używać MindSparQ AI przez ACP, skonfiguruj swój edytor tak, aby uruchamiał polecenie `opencode acp`.

Uruchamia to MindSparQ AI jako podproces zgodny z ACP, który komunikuje się z edytorem za pomocą JSON-RPC przez stdio.
...
Następnie wybierz „MindSparQ AI” w selektorze agentów AI Chat.
...
Aby używać MindSparQ AI jako agenta ACP w [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodaj następującą konfigurację do Neovim:
...
Ta konfiguracja sprawia, że CodeCompanion używa MindSparQ AI jako agenta ACP do czatu.
...
MindSparQ AI działa przez ACP tak samo, jak w terminalu. Obsługiwane są wszystkie główne funkcje:
...
- Serwery MCP zdefiniowane w konfiguracji MindSparQ AI
