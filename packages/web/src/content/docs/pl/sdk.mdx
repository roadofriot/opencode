---
title: SDK
description: Typowany klient JS dla serwera MindSparQ AI.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Pakiet SDK JS/TS MindSparQ AI zapewnia klienta z bezpiecznym typowaniem (type-safe) do interakcji z serwerem.
Użyj go do budowania integracji i programowej kontroli MindSparQ AI.
...
Jeśli masz już działającą instancję MindSparQ AI, możesz utworzyć instancję klienta, aby się z nią połączyć:
...
```typescript
import type { Session, Message, Part } from "@mindsparq-ai/sdk"
```
