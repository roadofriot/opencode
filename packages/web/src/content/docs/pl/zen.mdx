---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez MindSparQ AI.
---
...
MindSparQ AI Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół MindSparQ AI.

Zen działa jak każdy inny dostawca w MindSparQ AI. Logujesz się do MindSparQ AI Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z MindSparQ AI.
:::
...
MindSparQ AI Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

MindSparQ AI Zen działa jak każdy inny dostawca w MindSparQ AI.

1. Logujesz się do **<a href={console}>MindSparQ AI Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz MindSparQ AI Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji MindSparQ AI używa formatu
...
- DeepSeek V4 Flash Free jest dostępny w MindSparQ AI przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w MindSparQ AI przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w MindSparQ AI przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w MindSparQ AI przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w MindSparQ AI przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy MindSparQ AI Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w MindSparQ AI także dowolnego innego dostawcy.
