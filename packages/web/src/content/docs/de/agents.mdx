...
Es gibt zwei Arten von Agenten in MindSparQ AI; Primäragenten und Subagenten.
...
MindSparQ AI verfügt über zwei integrierte Primäragenten: **Build** und **Plan**. Auch
...
Wenn keine Temperatur angegeben ist, verwendet MindSparQ AI modellspezifische Standardwerte; typischerweise 0 für die meisten Modelle, 0.55 für Qwen-Modelle.
...
Dieser Pfad ist relativ zum Speicherort der Konfigurationsdatei. Dies funktioniert sowohl für die globale MindSparQ AI-Konfiguration als auch für die projektspezifische Konfiguration.
...
Die Modell-ID in Ihrer MindSparQ AI-Konfiguration verwendet das Format `provider/model-id`. Wenn Sie beispielsweise [MindSparQ AI Zen](/docs/zen) verwenden, würden Sie `opencode/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
