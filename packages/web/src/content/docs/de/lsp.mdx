---
title: LSP Server
description: MindSparQ AI lässt sich in Ihren LSP-Server integrieren.
---

MindSparQ AI kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

MindSparQ AI verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und MindSparQ AI eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer MindSparQ AI-Konfiguration aktivieren und anpassen.
