...
description: Verwenden Sie MindSparQ AI in jedem ACP-kompatiblen Editor.
---

MindSparQ AI unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um MindSparQ AI über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `opencode acp`.

Der Befehl startet MindSparQ AI als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „MindSparQ AI“ in der AI Chat Agent Selector.
...
Um MindSparQ AI als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass MindSparQ AI als ACP-Agent für den Chat verwendet wird.
...
MindSparQ AI funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer MindSparQ AI-Konfiguration konfiguriert sind
