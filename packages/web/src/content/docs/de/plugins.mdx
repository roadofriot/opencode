---
title: Plugins
description: Schreiben Sie Ihre eigenen Plugins, um MindSparQ AI zu erweitern.
---

Mit Plugins können Sie MindSparQ AI erweitern, indem Sie verschiedene Ereignisse einbinden und das Verhalten anpassen. Sie können Plugins erstellen, um neue Funktionen hinzuzufügen, externe Dienste zu integrieren oder das Standardverhalten von MindSparQ AI zu ändern.
...
MindSparQ AI führt beim Start `bun install` aus, um diese zu installieren. Ihre Plugins und Tools können sie dann importieren.
...
- `client`: Ein MindSparQ AI-SDK-Client für die Interaktion mit AI.
...
Hier sind einige Beispiele für Plugins, mit denen Sie MindSparQ AI erweitern können.
...
:::note
Wenn Sie die MindSparQ AI-Desktop-App verwenden, kann diese automatisch Systembenachrichtigungen senden, wenn eine Antwort bereit ist oder wenn in einer Sitzung ein Fehler auftritt.
:::
...
Verhindern Sie, dass MindSparQ AI `.env`-Dateien liest:
...
Plugins können MindSparQ AI auch benutzerdefinierte Tools hinzufügen:

```ts title=".opencode/plugins/custom-tools.ts"
import { type Plugin, tool } from "@mindsparq-ai/plugin"
...
Der `tool`-Helfer erstellt ein benutzerdefiniertes Tool, das MindSparQ AI aufrufen kann. Es verwendet eine Zod-Schemafunktion und gibt eine Tooldefinition zurück mit:
...
Ihre benutzerdefinierten Tools stehen neben den integrierten Tools für MindSparQ AI zur Verfügung.
