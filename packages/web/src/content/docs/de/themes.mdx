...
Mit MindSparQ AI kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet MindSparQ AI das `opencode`-Theme.
...
MindSparQ AI liefert mehrere eingebaute Themes mit.
...
- MindSparQ AI optisch ans Terminal anpassen wollen
...
MindSparQ AI unterstuetzt ein flexibles JSON-basiertes Theme-System.
