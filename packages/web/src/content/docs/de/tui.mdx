---
title: TUI
description: Arbeite mit MindSparQ AI in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MindSparQ AI bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet MindSparQ AI die TUI im aktuellen Verzeichnis.
...
In der MindSparQ AI-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu MindSparQ AI hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet MindSparQ AI. _Aliase_: `/quit`, `/q`
...
- `leader_timeout` - Steuert, wie lange MindSparQ AI nach der leader key wartet. Standard ist `2000`.
