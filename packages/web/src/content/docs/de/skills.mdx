...
Agent Skills erlauben MindSparQ AI, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
MindSparQ AI sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft MindSparQ AI vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
MindSparQ AI listet verfuegbare Skills in der Beschreibung des `skill`-Tools.
