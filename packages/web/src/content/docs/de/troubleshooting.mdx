...
Wenn MindSparQ AI Probleme macht, starte mit Logs und lokal gespeicherten Daten auf der Festplatte.
...
MindSparQ AI Desktop startet im Hintergrund einen lokalen MindSparQ AI-Server (`opencode-cli`-Sidecar).
...
- Nur macOS: `MindSparQ AI`-Menue -> **Reload Webview** (hilft bei leerer/eingefrorener UI)
...
MindSparQ AI kann auch lokale Plugins von der Festplatte laden. Verschiebe diese voruebergehend (oder benenne den Ordner um) und starte die Desktop-App neu:
...
Wenn das Deaktivieren von Plugins nicht hilft (oder eine Plugin-Installation haengt), leere den Cache, damit MindSparQ AI ihn neu aufbauen kann.

1. Beende MindSparQ AI Desktop komplett.
...
3. Starte MindSparQ AI Desktop neu.

---

### Server-Verbindungsprobleme beheben

MindSparQ AI Desktop kann entweder einen eigenen lokalen Server starten (Standard) oder sich mit einer konfigurierten Server-URL verbinden.
...
Unter Windows benoetigt MindSparQ AI Desktop die Microsoft Edge **WebView2 Runtime**. Wenn die App ein leeres Fenster zeigt oder nicht startet, installiere/aktualisiere WebView2 und versuche es erneut.

---

### Windows: Allgemeine Performance-Probleme

Wenn du langsame Performance, Dateizugriffsprobleme oder Terminal-Probleme unter Windows hast, versuche [WSL (Windows Subsystem for Linux)](/docs/windows-wsl). WSL bietet eine Linux-Umgebung, die nahtloser mit MindSparQ AI-Features funktioniert.

---

### Benachrichtigungen werden nicht angezeigt

MindSparQ AI Desktop zeigt Systembenachrichtigungen nur wenn:

- Benachrichtigungen fuer MindSparQ AI in den OS-Einstellungen aktiviert sind, und
...
1. Beende MindSparQ AI Desktop.
2. Finde und loesche diese Dateien (im App-Data-Verzeichnis von MindSparQ AI Desktop):
...
Wenn du Probleme mit MindSparQ AI hast:
