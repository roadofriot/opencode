...
MindSparQ AI Go ist ein kostengünstiges Abonnement — **5 $ für deinen ersten Monat**, danach **10 $/Monat** —, das dir zuverlässigen Zugriff auf beliebte offene Coding-Modelle bietet.

Go funktioniert wie jeder andere Provider in MindSparQ AI. Du abonnierst MindSparQ AI Go und
erhältst deinen API-Key. Es ist **völlig optional** und du musst es nicht nutzen, um
MindSparQ AI zu verwenden.
...
MindSparQ AI Go bietet dir Zugriff auf diese Modelle für **5 $ im ersten Monat**, danach **10 $/Monat**.

---

## Wie es funktioniert

MindSparQ AI Go funktioniert wie jeder andere Provider in MindSparQ AI.

1. Du meldest dich bei **<a href={console}>MindSparQ AI Zen</a>** an, abonnierst Go und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst `MindSparQ AI Go` und fügst deinen API-Key ein.
3. Führe `/models` in der TUI aus, um die Liste der über Go verfügbaren Modelle zu sehen.

:::note
Nur ein Mitglied pro Workspace kann MindSparQ AI Go abonnieren.
:::
...
MindSparQ AI Go beinhaltet die folgenden Limits:
...
Die [Modell-ID](/docs/config/#models) in deiner MindSparQ AI Config verwendet das Format `opencode-go/<model-id>`. Für Kimi K2.7 Code würdest du beispielsweise `opencode-go/kimi-k2.7-code` in deiner Config verwenden.
...
Wir haben MindSparQ AI Go entwickelt, um:
...
4. **Keinen Lock-in-Effekt** zu haben, indem wir dir ermöglichen, auch jeden anderen Provider mit MindSparQ AI zu nutzen.
