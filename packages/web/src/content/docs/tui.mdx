---
title: TUI
description: Using the MindSparQ AI terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MindSparQ AI provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running MindSparQ AI starts the TUI for the current directory.
...
When using the MindSparQ AI TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to MindSparQ AI. Allows you to select from available providers and add their API keys.
...
Exit MindSparQ AI. _Aliases_: `/quit`, `/q`
...
- `leader_timeout` - Controls how long MindSparQ AI waits after the leader key. Defaults to `2000`.
