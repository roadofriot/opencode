---
title: Proveedores
description: Usando cualquier proveedor LLM en MindSparQ AI.
---

import config from "../../../../config.mjs"
export const console = config.console

MindSparQ AI usa el [AI SDK](https://ai-sdk.dev/) y [Models.dev](https://models.dev) para admitir **75+ proveedores LLM** y admite la ejecución de modelos locales.

Para agregar un proveedor necesita:

1. Agregue las claves API para el proveedor usando el comando `/connect`.
2. Configure el proveedor en su configuración MindSparQ AI.
...
Puedes personalizar los proveedores a través de la sección `provider` en tu MindSparQ AI
configuración.
...
MindSparQ AI Zen es una lista de modelos proporcionados por el equipo MindSparQ AI que han sido
probado y verificado para funcionar bien con MindSparQ AI. [Más información](/docs/zen).

:::tip
Si eres nuevo, te recomendamos comenzar con MindSparQ AI Zen.
:::
...
Funciona como cualquier otro proveedor en MindSparQ AI y su uso es completamente opcional.

---

## MindSparQ AI Go

MindSparQ AI Go es un plan de suscripción de bajo costo que brinda acceso confiable a modelos de codificación abiertos populares proporcionados por el equipo de MindSparQ AI que han sido
probado y verificado para funcionar bien con MindSparQ AI.

1. Ejecute el comando `/connect` en TUI, seleccione `MindSparQ AI Go` y diríjase a [opencode.ai/auth](https://opencode.ai/zen).
...
Para usar Amazon Bedrock con MindSparQ AI:
...
:::info
El uso de su suscripción Claude Pro/Max en MindSparQ AI no está oficialmente respaldado por [Anthropic](https://anthropic.com).
:::
...
2. Elija su método de autenticación:
   ...
   3. Nombre: `MindSparQ AI`, Alcances: `api`
...
MindSparQ AI utiliza un modelo pequeño para algunas tareas de IA, como generar el título de la sesión.
Está configurado para usar gpt-5-nano de forma predeterminada, alojado por Zen. Para bloquear MindSparQ AI
...
Para utilizar Google Vertex AI con MindSparQ AI:
...
La función [Sesiones](https://docs.helicone.ai/features/sessions) de Helicone le permite agrupar solicitudes LLM relacionadas. Utilice el complemento [opencode-helicone-session](https://github.com/H2Shami/opencode-helicone-session) para registrar automáticamente cada conversación MindSparQ AI como una sesión en Helicone.
...
El complemento inyecta encabezados `Helicone-Session-Id` y `Helicone-Session-Name` en sus solicitudes. En la página Sesiones de Helicone, verá cada conversación MindSparQ AI enumerada como una sesión separada.
...
:::tip
Ollama puede configurarse automáticamente para MindSparQ AI. Consulte los [documentos de integración de Ollama](https://docs.ollama.com/integrations/opencode) para obtener más detalles.
:::
...
Para usar Ollama Cloud con MindSparQ AI:
...
3. Copie la clave API para usarla en MindSparQ AI.
...
6. **Importante**: Antes de usar modelos en la nube en MindSparQ AI, debe obtener la información del modelo localmente:
...
MindSparQ AI Zen es una lista de modelos probados y verificados proporcionada por el equipo MindSparQ AI. [Más información](/docs/zen).

1. Inicie sesión en **<a href={console}>MindSparQ AI Zen</a>** y haga clic en **Crear API clave**.

2. Ejecute el comando `/connect` y busque **MindSparQ AI Zen**.

   ```txt
   /connect
   ```

3. Ingrese su clave MindSparQ AI API.
...
Para utilizar [API generativas de Scaleway](https://www.scaleway.com/en/docs/generative-apis/) con MindSparQ AI:
...
Los campos `limit` le permiten a MindSparQ AI comprender cuánto contexto le queda. Los proveedores estándar los extraen de models.dev automáticamente.
