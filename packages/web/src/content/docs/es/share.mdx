---
title: Compartir
description: Comparte tus conversaciones MindSparQ AI.
---

La función para compartir de MindSparQ AI te permite crear enlaces públicos a tus conversaciones de MindSparQ AI, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, MindSparQ AI:
...
MindSparQ AI admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, MindSparQ AI usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
