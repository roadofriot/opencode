---
title: TUI
description: Usando la interfaz de usuario del terminal MindSparQ AI.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MindSparQ AI proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar MindSparQ AI se inicia TUI para el directorio actual.
...
Cuando utilice MindSparQ AI TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a MindSparQ AI. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de MindSparQ AI. _Alias_: `/quit`, `/q`
...
- `leader_timeout`: controla cuánto tiempo espera MindSparQ AI después de la leader key. El valor predeterminado es `2000`.
