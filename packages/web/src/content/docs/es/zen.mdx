---
title: Zen
description: Lista seleccionada de modelos proporcionada por MindSparQ AI.
---
...
MindSparQ AI Zen es una lista de modelos probados y verificados proporcionada por el equipo de MindSparQ AI.

Zen funciona como cualquier otro proveedor en MindSparQ AI. Inicias sesión en MindSparQ AI Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con MindSparQ AI.
:::
...
MindSparQ AI Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

MindSparQ AI Zen funciona como cualquier otro proveedor en MindSparQ AI.

1. Inicias sesión en **<a href={console}>MindSparQ AI Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas MindSparQ AI Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de MindSparQ AI
...
- DeepSeek V4 Flash Free está disponible en MindSparQ AI por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo-V2.5 Free está disponible en MindSparQ AI por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- North Mini Code Free está disponible en MindSparQ AI por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Ultra Free está disponible en MindSparQ AI por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en MindSparQ AI por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con MindSparQ AI.
