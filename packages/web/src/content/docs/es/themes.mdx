...
Con MindSparQ AI puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, MindSparQ AI usa nuestro propio tema `opencode`.
...
MindSparQ AI viene con varios temas integrados.
...
- Quiere que MindSparQ AI coincida con la apariencia de su terminal
...
MindSparQ AI admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
