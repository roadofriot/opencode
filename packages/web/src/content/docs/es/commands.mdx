...
Puede agregar comandos personalizados a través de la configuración MindSparQ AI o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su MindSparQ AI [config](/docs/config):
