...
Las habilidades del agente permiten a MindSparQ AI descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
MindSparQ AI busca estas ubicaciones:
...
Para las rutas locales del proyecto, MindSparQ AI sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
MindSparQ AI enumera las habilidades disponibles en la descripción de la herramienta `skill`.
