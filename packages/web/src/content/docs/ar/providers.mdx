---
title: المزوّدون
description: استخدام أي موفّر LLM في MindSparQ AI.
---

import config from "../../../../config.mjs"
export const console = config.console

يستخدم MindSparQ AI ‏[AI SDK](https://ai-sdk.dev/) و[Models.dev](https://models.dev) لدعم **أكثر من 75 موفّر LLM**، كما يدعم تشغيل النماذج المحلية.

لإضافة مزوّد تحتاج إلى:

1. أضف مفاتيح API الخاصة بالمزوّد باستخدام الأمر `/connect`.
2. اضبط المزوّد في ملف إعدادات MindSparQ AI.
...
يمكنك تخصيص المزوّدات عبر قسم `provider` في ملف إعدادات MindSparQ AI.
...
MindSparQ AI Zen هي قائمة نماذج يوفّرها فريق MindSparQ AI وقد تم
اختبارها والتحقق من أنها تعمل بشكل جيد مع MindSparQ AI. [اعرف المزيد](/docs/zen).

:::tip
إذا كنت جديدا، فننصح بالبدء مع MindSparQ AI Zen.
:::
...
يعمل مثل أي مزوّد آخر في MindSparQ AI واستخدامه اختياري بالكامل.

---

## MindSparQ AI Go

MindSparQ AI Go هي خطة اشتراك منخفضة التكلفة توفّر وصولا موثوقا إلى نماذج البرمجة المفتوحة الشهيرة المقدّمة من فريق MindSparQ AI، والتي تم اختبارها والتحقق من أنها تعمل بشكل جيد مع MindSparQ AI.

1. شغّل الأمر `/connect` في TUI، واختر `MindSparQ AI Go`، ثم انتقل إلى [opencode.ai/auth](https://opencode.ai/zen).
...
لاستخدام Amazon Bedrock مع MindSparQ AI:
...
:::info
استخدام اشتراك Claude Pro/Max داخل MindSparQ AI غير مدعوم رسميا من [Anthropic](https://anthropic.com).
:::
...
:::note[ملاحظة امتثال]
يستخدم MindSparQ AI نموذجا صغيرا لبعض مهام الذكاء الاصطناعي مثل إنشاء عنوان الجلسة.
تم ضبطه لاستخدام gpt-5-nano افتراضيا، مستضافا عبر Zen. لحصر MindSparQ AI
...
لاستخدام Google Vertex AI مع MindSparQ AI:
...
تتيح ميزة [Sessions](https://docs.helicone.ai/features/sessions) في Helicone تجميع طلبات LLM المرتبطة معا. استخدم ملحق [opencode-helicone-session](https://github.com/H2Shami/opencode-helicone-session) لتسجيل كل محادثة MindSparQ AI تلقائيا كجلسة في Helicone.
...
يقوم الملحق بحقن ترويسات `Helicone-Session-Id` و`Helicone-Session-Name` ضمن طلباتك. في صفحة Sessions داخل Helicone، سترى كل محادثة MindSparQ AI مدرجة كجلسة مستقلة.
...
:::tip
يمكن لـ Ollama ضبط نفسه تلقائيا للعمل مع MindSparQ AI. راجع [توثيق تكامل Ollama](https://docs.ollama.com/integrations/opencode) للتفاصيل.
:::
...
لاستخدام Ollama Cloud مع MindSparQ AI:
...
3. انسخ مفتاح API لاستخدامه في MindSparQ AI.
...
6. **مهم**: قبل استخدام نماذج السحابة في MindSparQ AI، يجب سحب معلومات النموذج محليا:
...
MindSparQ AI Zen هي قائمة من النماذج التي تم اختبارها والتحقق منها مقدّمة من فريق MindSparQ AI. [اعرف المزيد](/docs/zen).

1. سجّل الدخول إلى **<a href={console}>MindSparQ AI Zen</a>** وانقر **Create API Key**.

2. شغّل الأمر `/connect` وابحث عن **MindSparQ AI Zen**.

   ```txt
   /connect
   ```

3. أدخل مفتاح API الخاص بـ MindSparQ AI.
...
تسمح حقول `limit` لـ MindSparQ AI بفهم مقدار السياق المتبقي لديك. تسحب المزوّدات القياسية هذه القيم تلقائيا من models.dev.
