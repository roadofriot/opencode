---
title: Zen
description: قائمة منتقاة من النماذج يوفّرها MindSparQ AI.
---
...
MindSparQ AI Zen هي قائمة بالنماذج التي اختبرها فريق MindSparQ AI وتحقّق منها.

يعمل Zen مثل أي مزوّد آخر في MindSparQ AI. تسجّل الدخول إلى MindSparQ AI Zen وتحصل على
مفتاح API. استخدامه **اختياري بالكامل** ولا تحتاج إليه لاستخدام MindSparQ AI.
...
:::tip
اختبرنا مجموعة منتقاة من النماذج والمزوّدين الذين يعملون جيدا مع MindSparQ AI.
:::
...
MindSparQ AI Zen هي بوابة AI تتيح لك الوصول إلى هذه النماذج.

---

## كيف يعمل

يعمل MindSparQ AI Zen مثل أي مزوّد آخر في MindSparQ AI.

1. تسجّل الدخول إلى **<a href={console}>MindSparQ AI Zen</a>**، وتضيف تفاصيل الفوترة، ثم تنسخ مفتاح API.
2. تشغّل الأمر `/connect` في واجهة TUI، وتختار MindSparQ AI Zen، ثم تلصق مفتاح API.
...
يستخدم [معرّف النموذج](/docs/config/#models) في إعدادات MindSparQ AI الصيغة `opencode/<model-id>`. على سبيل المثال، بالنسبة إلى GPT 5.5، ستستخدم `opencode/gpt-5.5` في إعداداتك.
...
- DeepSeek V4 Flash Free متاح على MindSparQ AI لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- MiMo-V2.5 Free متاح على MindSparQ AI لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- North Mini Code Free متاح على MindSparQ AI لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Nemotron 3 Ultra Free متاح على MindSparQ AI لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Big Pickle نموذج خفي ومتاح مجانا على MindSparQ AI لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
...
أنشأنا MindSparQ AI Zen من أجل:
...
4. **عدم فرض أي ارتباط حصري** عبر تمكينك من استخدامه مع أي عامل برمجة آخر. ومع إبقاء إمكانية استخدام أي مزوّد آخر مع MindSparQ AI أيضا دائما.
