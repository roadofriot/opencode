...
تتيح مهارات الوكيل لـ MindSparQ AI اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
يبحث MindSparQ AI في هذه المواقع:
...
بالنسبة لمسارات المشروع المحلية، يتدرج MindSparQ AI صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
يعرض MindSparQ AI المهارات المتاحة في وصف أداة `skill`.
