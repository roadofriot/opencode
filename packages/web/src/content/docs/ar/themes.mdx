...
مع MindSparQ AI يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم MindSparQ AI سمتنا `opencode`.
...
يأتي MindSparQ AI مع عدة سمات مدمجة.
...
- يريدون أن يطابق MindSparQ AI مظهر terminal لديهم
...
يدعم MindSparQ AI نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
