---
title: TUI
description: استخدام واجهة المستخدم TUI في MindSparQ AI.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر MindSparQ AI واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل MindSparQ AI إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة MindSparQ AI في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى MindSparQ AI. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من MindSparQ AI. _الأسماء المستعارة_: `/quit`, `/q`
...
- `leader_timeout` - يتحكم في مدة انتظار MindSparQ AI بعد الضغط على leader key. القيمة الافتراضية `2000`.
