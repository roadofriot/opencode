...
Det er to typer agenter i MindSparQ AI; primære agenter og underagenter.
...
MindSparQ AI kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
MindSparQ AI kommer med tre innebygde underagenter, **General**, **Explore** og **Scout**. Vi skal se på dette nedenfor.

---

## Innebygd

MindSparQ AI kommer med to innebygde primære agenter og tre innebygde underagenter.
...
Hvis ingen temperatur er spesifisert, bruker MindSparQ AI modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale MindSparQ AI-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i MindSparQ AI-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [MindSparQ AI Zen](/docs/zen), vil du bruke `opencode/gpt-5.1-codex` for GPT 5.1 Codex.
