---
title: Tjener
description: Samhandle med MindSparQ AI-tjener over HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Kommandoen `opencode serve` kjører en hodeløs HTTP-server som eksponerer et OpenAPI-endepunkt som en MindSparQ AI-klient kan bruke.
...
:::tip
Bruk MindSparQ AI-serveren til å samhandle med MindSparQ AI programmatisk.
:::

Denne arkitekturen lar MindSparQ AI støtte flere klienter og lar deg samhandle med MindSparQ AI programmatisk.

Du kan kjøre `opencode serve` for å starte en frittstående server. Hvis du har
MindSparQ AI TUI kjører, vil `opencode serve` starte en ny server.
...
[`/tui`](#tui) endepunktet kan brukes til å kjøre TUI gjennom serveren. Du kan for eksempel forhåndsutfylle eller kjøre en forespørsel. Dette oppsettet brukes av MindSparQ AI [IDE](/docs/ide) plugins.
