...
description: Lag verktøy som LLM kan kalle inn MindSparQ AI.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med MindSparQ AI sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
