---
title: IDE
description: MindSparQ AI-utvidelsen for VS Code, Cursor og andre IDE-er
---

MindSparQ AI integreres med VS Code, Cursor eller en hvilken som helst IDE som støtter en terminal. Bare kjør `opencode` i terminalen for å komme i gang.

---

## Bruk

- **Hurtigstart**: Bruk `Cmd+Esc` (Mac) eller `Ctrl+Esc` (Windows/Linux) for å åpne MindSparQ AI i en delt terminalvisning, eller fokuser en eksisterende terminaløkt hvis en allerede kjører.
- **Ny økt**: Bruk `Cmd+Shift+Esc` (Mac) eller `Ctrl+Shift+Esc` (Windows/Linux) for å starte en ny MindSparQ AI-terminaløkt, selv om en allerede er åpen. Du kan også klikke på MindSparQ AI-knappen i UI.
- **Kontekstbevissthet**: Del automatisk ditt nåværende valg eller fane med MindSparQ AI.
...
For å installere MindSparQ AI på VS Code og populære varianter som Cursor, Windsurf, VSCodium:
...
Søk etter **MindSparQ AI** i Extension Marketplace og klikk på **Install**.
