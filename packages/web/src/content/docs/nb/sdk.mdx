---
title: SDK
description: Typesikker JS-klient for MindSparQ AI-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

MindSparQ AI JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere MindSparQ AI programmatisk.
...
Opprett en forekomst av MindSparQ AI:
...
Hvis du allerede har en kjørende forekomst av MindSparQ AI, kan du opprette en klientforekomst for å koble til den:
