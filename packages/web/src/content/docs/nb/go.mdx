...
MindSparQ AI Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

Go fungerer som enhver annen leverandør i MindSparQ AI. Du abonnerer på MindSparQ AI Go og
...
MindSparQ AI Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

MindSparQ AI Go fungerer som enhver annen leverandør i MindSparQ AI.

1. Du logger inn på **<a href={console}>MindSparQ AI Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `MindSparQ AI Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på MindSparQ AI Go.
:::
...
MindSparQ AI Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din MindSparQ AI-konfigurasjon
...
Vi opprettet MindSparQ AI Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med MindSparQ AI også.
