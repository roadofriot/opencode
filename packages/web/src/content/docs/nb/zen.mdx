---
title: Zen
description: Utvalgt liste over modeller levert av MindSparQ AI.
---
...
MindSparQ AI Zen er en liste over testede og verifiserte modeller levert av MindSparQ AI-teamet.

Zen fungerer som enhver annen leverandør i MindSparQ AI. Du logger inn på MindSparQ AI Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med MindSparQ AI.
:::
...
MindSparQ AI Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

MindSparQ AI Zen fungerer som enhver annen leverandør i MindSparQ AI.

1. Du logger inn på **<a href={console}>MindSparQ AI Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger MindSparQ AI Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i MindSparQ AI-konfigurasjonen din
...
- DeepSeek V4 Flash Free er tilgjengelig på MindSparQ AI i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på MindSparQ AI i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- North Mini Code Free er tilgjengelig på MindSparQ AI i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på MindSparQ AI i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på MindSparQ AI i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet MindSparQ AI Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med MindSparQ AI også.
