...
MindSparQ AI gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre MindSparQ AI starter TUI for gjeldende katalog.
...
Når du bruker MindSparQ AI TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til MindSparQ AI. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt MindSparQ AI. _Aliaser_: `/quit`, `/q`
...
- `leader_timeout` - Styrer hvor lenge MindSparQ AI venter etter leader key. Standard er `2000`.
