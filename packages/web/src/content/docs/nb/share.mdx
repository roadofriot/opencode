...
Delingsfunksjonen i MindSparQ AI lar deg lage offentlige lenker til dine MindSparQ AI-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Som standard bruker MindSparQ AI manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
