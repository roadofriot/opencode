...
description: Skriv dine egne programtillegg for å utvide MindSparQ AI.
---

Plugins lar deg utvide MindSparQ AI ved å koble til ulike hendelser og tilpasse atferd. Du kan lage plugins for å legge til nye funksjoner, integrere med eksterne tjenester eller endre standardoppførselen til MindSparQ AI.
...
MindSparQ AI kjører `bun install` ved oppstart for å installere disse. Programtilleggene og verktøyene dine kan deretter importere dem.
...
- `client`: En MindSparQ AI SDK klient for samhandling med AI.
...
Her er noen eksempler på plugins du kan bruke for å utvide MindSparQ AI.
...
:::note
Hvis du bruker MindSparQ AI-skrivebordsappen, kan den sende systemvarsler automatisk når et svar er klart eller når en økt feiler.
:::
...
Hindre MindSparQ AI fra å lese `.env` filer:
...
Plugins kan også legge til egendefinerte verktøy til MindSparQ AI:
...
`tool`-hjelperen lager et tilpasset verktøy som MindSparQ AI kan kalle. Den tar en Zod-skjemafunksjon og returnerer en verktøydefinisjon med:

- `description`: Hva verktøyet gjør
- `args`: Zod-skjema for verktøyets argumenter
  - `execute`: Funksjon som kjører når verktøyet kalles

Dine egendefinerte verktøy vil være tilgjengelige for MindSparQ AI sammen med innebygde verktøy.
