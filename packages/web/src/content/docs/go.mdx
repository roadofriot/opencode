...
MindSparQ AI Go is a low cost subscription — **$5 for your first month**, then **$10/month** — that gives you reliable access to popular open coding models.

Go works like any other provider in MindSparQ AI. You subscribe to MindSparQ AI Go and
...
MindSparQ AI Go gives you access to these models for **$5 for your first month**, then **$10/month**.

---

## How it works

MindSparQ AI Go works like any other provider in MindSparQ AI.

1. You sign in to **<a href={console}>MindSparQ AI Zen</a>**, subscribe to Go, and
   copy your API key.
2. You run the `/connect` command in the TUI, select `MindSparQ AI Go`, and paste
   your API key.
3. Run `/models` in the TUI to see the list of models available through Go.

:::note
Only one member per workspace can subscribe to MindSparQ AI Go.
:::
...
MindSparQ AI Go includes the following limits:
...
4. Have **no lock-in** by allowing you to use any other provider with MindSparQ AI as well.
