---
title: Zen
description: Curated list of models provided by MindSparQ AI.
---
...
MindSparQ AI Zen is a list of tested and verified models provided by the MindSparQ AI team.

Zen works like any other provider in MindSparQ AI. You login to MindSparQ AI Zen and get
...
:::tip
We tested a select group of models and providers that work well with MindSparQ AI.
:::
...
MindSparQ AI Zen is an AI gateway that gives you access to these models.

---

## How it works

MindSparQ AI Zen works like any other provider in MindSparQ AI.

1. You sign in to **<a href={console}>MindSparQ AI Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select MindSparQ AI Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your MindSparQ AI config
...
- DeepSeek V4 Flash Free is available on MindSparQ AI for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo-V2.5 Free is available on MindSparQ AI for a limited time. The team is using this time to collect feedback and improve the model.
- North Mini Code Free is available on MindSparQ AI for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Ultra Free is available on MindSparQ AI for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on MindSparQ AI for a limited time. The team is using this time to collect feedback and improve the model.
...
We created MindSparQ AI Zen to:
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with MindSparQ AI as well.
