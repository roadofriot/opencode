...
Agent skills let MindSparQ AI discover reusable instructions from your repo or home directory.
...
MindSparQ AI searches these locations:
...
For project-local paths, MindSparQ AI walks up from your current working directory until it reaches the git worktree.
...
MindSparQ AI lists available skills in the `skill` tool description.
