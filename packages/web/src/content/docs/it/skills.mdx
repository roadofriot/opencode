...
Le skill degli agenti permettono a MindSparQ AI di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
MindSparQ AI cerca in queste posizioni:
...
Per i percorsi locali al progetto, MindSparQ AI risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
MindSparQ AI elenca le skill disponibili nella descrizione dello strumento `skill`.
