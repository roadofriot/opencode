---
title: Supporto ACP
description: Usa MindSparQ AI in qualunque editor compatibile con ACP.
---

MindSparQ AI supporta [Agent Client Protocol](https://agentclientprotocol.com) (ACP), permettendoti di usarlo direttamente in editor e IDE compatibili.
...
Per usare MindSparQ AI via ACP, configura l'editor in modo che esegua il comando `opencode acp`.

Il comando avvia MindSparQ AI come sottoprocesso compatibile con ACP che comunica con l'editor via JSON-RPC su stdio.
...
Per aprirlo, seleziona il nuovo agente 'MindSparQ AI' nel selettore agenti di AI Chat.
...
Per usare MindSparQ AI come agente ACP in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), aggiungi quanto segue alla config di Neovim:
...
Questa config imposta CodeCompanion per usare MindSparQ AI come agente ACP per la chat.
...
MindSparQ AI funziona via ACP come nel terminale. Tutte le funzionalita sono supportate:
:::note
...
- Server MCP configurati nella tua configurazione MindSparQ AI
