---
title: TUI
description: Usa l'interfaccia utente da terminale (TUI) di MindSparQ AI.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MindSparQ AI fornisce un'interfaccia interattiva da terminale (TUI) per lavorare sui tuoi progetti con un LLM.

Eseguire MindSparQ AI avvia la TUI per la directory corrente.
...
Quando usi la TUI di MindSparQ AI, puoi digitare `/` seguito dal nome di un comando per eseguire rapidamente azioni. Per esempio:
...
Aggiunge un provider a MindSparQ AI. Ti permette di selezionare tra i provider disponibili e aggiungere le relative chiavi API.
...
Esce da MindSparQ AI. _Alias_: `/quit`, `/q`
...
- `leader_timeout` - Controlla per quanto tempo MindSparQ AI attende dopo il leader key. Default: `2000`.
