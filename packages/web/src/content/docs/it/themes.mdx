...
Con MindSparQ AI puoi scegliere tra diversi temi integrati, usare un tema che si adatta al tema del tuo terminale oppure definire un tema personalizzato.

Per impostazione predefinita, MindSparQ AI usa il tema `opencode`.
...
MindSparQ AI include diversi temi integrati.
...
- Vuole che MindSparQ AI corrisponda all'aspetto del terminale
...
MindSparQ AI supporta un sistema di temi flessibile basato su JSON che permette di creare e personalizzare temi facilmente.
