---
title: Server LSP
description: MindSparQ AI si integra con i tuoi server LSP.
---

MindSparQ AI può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

MindSparQ AI include diversi server LSP integrati per linguaggi popolari:
