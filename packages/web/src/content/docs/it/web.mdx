---
title: Web
description: Usa MindSparQ AI nel browser.
---

MindSparQ AI puo funzionare come applicazione web nel browser, offrendo la stessa potente esperienza di coding AI senza bisogno di un terminale.

![MindSparQ AI Web - Nuova sessione](../../../assets/web/web-homepage-new-session.png)
...
Questo avvia un server locale su `127.0.0.1` con una porta disponibile scelta a caso e apre automaticamente MindSparQ AI nel browser predefinito.
...
Per impostazione predefinita, MindSparQ AI sceglie una porta disponibile. Puoi specificare una porta:
...
Per impostazione predefinita, il server si lega a `127.0.0.1` (solo localhost). Per rendere MindSparQ AI accessibile sulla rete:

```bash
opencode web --hostname 0.0.0.0
```

Usando `0.0.0.0`, MindSparQ AI mostrera sia l'indirizzo locale sia quello di rete:
...
Una volta avviata, l'interfaccia web ti da accesso alle tue sessioni MindSparQ AI.

### Sessioni

Visualizza e gestisci le sessioni dalla homepage. Puoi vedere le sessioni attive e avviarne di nuove.

![MindSparQ AI Web - Sessione attiva](../../../assets/web/web-homepage-active-session.png)

### Stato del server

Fai clic su "See Servers" per vedere i server connessi e il loro stato.

![MindSparQ AI Web - See Servers](../../../assets/web/web-homepage-see-servers.png)
