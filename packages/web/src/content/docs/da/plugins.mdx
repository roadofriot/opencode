---
title: Plugins
description: Skriv dine egne plugins for at udvide MindSparQ AI.
---

Plugins giver dig mulighed for at udvide MindSparQ AI ved at tilslutte sig forskellige begivenheder og tilpasse adfærd. Du kan oprette plugins for at tilføje nye funktioner, integrere med eksterne tjenester eller ændre MindSparQ AIs standardadfærd.
...
MindSparQ AI kører `bun install` ved opstart for at installere disse. Dine plugins og værktøjer kan derefter importere dem.
...
:::note
Hvis du bruger MindSparQ AI desktop-appen, kan den sende systemmeddelelser automatisk, når et svar er klar, eller når en session fejler.
:::
