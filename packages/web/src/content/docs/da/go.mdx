...
MindSparQ AI Go er et lavprisabonnement — **$5 for din første måned**, derefter **$10/måned** — der giver dig pålidelig adgang til populære åbne kodningsmodeller.

Go fungerer som enhver anden udbyder i MindSparQ AI. Du abonnerer på MindSparQ AI Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med MindSparQ AI.
:::
...
MindSparQ AI Go giver dig adgang til disse modeller for **$5 for din første måned**, derefter **$10/måned**.

---

## Sådan fungerer det

MindSparQ AI Go fungerer som enhver anden udbyder i MindSparQ AI.

1. Du logger ind på **<a href={console}>MindSparQ AI Zen</a>**, abonnerer på Go, og
   kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI'en, vælger `MindSparQ AI Go`, og indsætter
   din API-nøgle.
3. Kør `/models` i TUI'en for at se listen over tilgængelige modeller gennem Go.

:::note
Kun ét medlem per arbejdsområde kan abonnere på MindSparQ AI Go.
:::
...
MindSparQ AI Go inkluderer følgende grænser:
...
Dit [model id](/docs/config/#models) i din MindSparQ AI config
...
Vi skabte MindSparQ AI Go for at:
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med MindSparQ AI.
