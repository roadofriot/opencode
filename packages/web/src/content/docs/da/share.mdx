---
title: Deling
description: Del dine MindSparQ AI-samtaler.
---

MindSparQ AIs delingsfunksjon lar deg lage offentlige lenker til dine MindSparQ AI-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, MindSparQ AI:
...
MindSparQ AI støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger MindSparQ AI manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
