...
description: Brug MindSparQ AI i enhver ACP-kompatibel editor.
---

MindSparQ AI understøtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), så du kan bruge det direkte i kompatible editorer og IDE'er.
...
For at bruge MindSparQ AI via ACP, konfigurer din editor til at køre kommandoen `opencode acp`.

Kommandoen starter MindSparQ AI som en ACP-kompatibel underproces, der kommunikerer med din editor over JSON-RPC via stdio.
...
For at åbne den skal du bruge den nye 'MindSparQ AI'-agent i AI Chat-agentvælgeren.
...
For at bruge MindSparQ AI som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), skal du tilføje følgende til din Neovim-konfiguration:
...
Denne konfiguration sætter CodeCompanion til at bruge MindSparQ AI som ACP-agent til chat.
...
MindSparQ AI fungerer på samme måde via ACP som i terminalen. Alle funktioner understøtter:
...
- MCP-servere konfigureret i din MindSparQ AI-konfiguration
