---
title: Zen
description: Udvalgt liste over modeller leveret af MindSparQ AI.
---
...
MindSparQ AI Zen er en liste over testede og verificerede modeller leveret af MindSparQ AI-teamet.

Zen fungerer som enhver anden udbyder i MindSparQ AI. Du logger ind på MindSparQ AI Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med MindSparQ AI.
:::
...
MindSparQ AI Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

MindSparQ AI Zen fungerer som enhver anden udbyder i MindSparQ AI.

1. Du logger ind på **<a href={console}>MindSparQ AI Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger MindSparQ AI Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din MindSparQ AI-konfiguration
...
- DeepSeek V4 Flash Free er tilgængelig på MindSparQ AI i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på MindSparQ AI i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- North Mini Code Free er tilgængelig på MindSparQ AI i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på MindSparQ AI i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på MindSparQ AI i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
Vi skabte MindSparQ AI Zen for at:
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med MindSparQ AI også.
