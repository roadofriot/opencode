---
title: Udbydere
description: Brug en hvilken som helst LLM-udbyder i MindSparQ AI.
---

import config from "../../../../config.mjs"
export const console = config.console

MindSparQ AI bruger [AI SDK](https://ai-sdk.dev/) og [Models.dev](https://models.dev) til at understøtte **75+ LLM-udbydere** og understøtter kørsel af lokale modeller.

For at tilføje en udbyder skal du:

1. Tilføje API-nøglerne for udbyderen ved at bruge kommandoen `/connect`.
2. Konfigurere udbyderen i MindSparQ AI-konfigurationen.
...
Du kan tilpasse udbyderne gennem `provider`-delen i MindSparQ AI-konfigurationen.
...
MindSparQ AI Zen er en liste over modeller leveret af MindSparQ AI-teamet, som er blevet testet og verificeret til at fungere godt med MindSparQ AI. [Læs mere](/docs/zen).

:::tip
Hvis du er ny, anbefaler vi at starte med MindSparQ AI Zen.
:::
...
Det fungerer som alle andre udbydere i MindSparQ AI og er helt valgfrit at bruge.

---

## MindSparQ AI Go

MindSparQ AI Go er en billig abonnementsplan, der giver pålidelig adgang til populære åbne kodningsmodeller leveret af MindSparQ AI-teamet, som er testet og verificeret til at fungere godt med MindSparQ AI.

1. Kør kommandoen `/connect` i TUI, vælg `MindSparQ AI Go`, og gå til [opencode.ai/auth](https://opencode.ai/zen).
...
Sådan bruger du Amazon Bedrock med MindSparQ AI:
...
:::info
At bruge dit Claude Pro/Max-abonnement i MindSparQ AI understøttes ikke officielt af [Anthropic](https://anthropic.com).
:::
...
MindSparQ AI bruger en lille model til nogle AI-opgaver som at generere sessionstitlen.
Den er konfigureret til at bruge gpt-5-nano som standard, hostet af Zen. For at låse MindSparQ AI
...
Sådan bruger du GitHub Copilot-abonnementet med MindSparQ AI:
...
Sådan bruger du Google Vertex AI med MindSparQ AI:
...
Helicones [Sessions](https://docs.helicone.ai/features/sessions) funktion lader dig gruppe relaterede LLM anmodninger sammen. Brug [opencode-helicone-session](https://github.com/H2Shami/opencode-helicone-session) plugin for automatisk at logge hver MindSparQ AI-samtale som en session i Helicone.
...
Programmatisk injicerer `Helicone-Session-Id` og `Helicone-Session-Name` headers i dine anmodninger. På Helicones Sessions-side vil du se hver MindSparQ AI-samtale opført som en separat session.
...
:::tip
Ollama kan automatisk konfigurere sig selv for MindSparQ AI. Se [Ollama-integrationsdokumenterne](https://docs.ollama.com/integrations/opencode) for detaljer.
:::
...
Sådan bruger du Ollama Cloud med MindSparQ AI:
...
3. Kopier API-nøglen til brug i MindSparQ AI.
...
6. **Vigtigt**: Før du bruger skymodeller i MindSparQ AI, skal du hente modelinformationen lokalt:
...
MindSparQ AI Zen er en liste over testede og verificerede modeller leveret af MindSparQ AI-teamet. [Læs mere](/docs/zen).

1. Log på **<a href={console}>MindSparQ AI Zen</a>** og klik på **Create API Key**.

2. Kør kommandoen `/connect` og søg efter **MindSparQ AI Zen**.

   ```txt
   /connect
   ```

3. Indtast MindSparQ AI API-nøglen.
...
Sådan bruger du [Scaleway Generative APIs](https://www.scaleway.com/en/docs/generative-apis/) med MindSparQ AI:
...
`limit`-felterne lader MindSparQ AI forstå hvor meget kontekst du har tilbage. Standardudbydere henter disse automatisk fra models.dev.
