...
[`/tui`](#tui) endpointet kan bruges til at køre TUI gennem serveren. Du kan for eksempel forududfylde eller køre en forespørgsel. Denne opsætning bruges af MindSparQ AI [IDE](/docs/ide) plugins.
...
MindSparQ AI-serveren viser følgende API'er.
