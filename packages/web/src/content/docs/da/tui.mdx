---
title: TUI
description: Brug af MindSparQ AI-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

MindSparQ AI giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre MindSparQ AI starter TUI for den nuværende mappe.
...
Når du bruger MindSparQ AI TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til MindSparQ AI. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut MindSparQ AI. _Aliaser_: `/quit`, `/q`
...
- `leader_timeout` - Styrer hvor længe MindSparQ AI venter efter leader key. Standard er `2000`.
