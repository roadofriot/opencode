...
Med MindSparQ AI kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger MindSparQ AI vårt eget `opencode`-tema.
...
MindSparQ AI kommer med flere innebygde temaer.
...
- Vil at MindSparQ AI skal matche terminalens utseende
...
MindSparQ AI støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.
