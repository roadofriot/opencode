...
Agentferdigheter lar MindSparQ AI oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
MindSparQ AI søker etter disse stedene:
...
For prosjektlokale stier går MindSparQ AI opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
MindSparQ AI viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
