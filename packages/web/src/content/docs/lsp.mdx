---
title: LSP Servers
description: MindSparQ AI integrates with your LSP servers.
---

MindSparQ AI can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

MindSparQ AI comes with several built-in LSP servers for popular languages:
