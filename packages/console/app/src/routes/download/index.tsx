...
import desktopAppIcon from "../../asset/lander/mindsparq-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://mindsparq.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>mindsparq.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g mindsparq-ai")}>
                <code>
                  npm i -g <strong>mindsparq-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g mindsparq-ai")}>
                <code>
                  bun add -g <strong>mindsparq-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/mindsparq")}>
                <code>
                  brew install <strong>anomalyco/tap/mindsparq</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S mindsparq")}>
                <code>
                  paru -S <strong>mindsparq</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask mindsparq-desktop")}>
                <code>
                  brew install --cask <strong>mindsparq-desktop</strong>
                </code>
                <CopyStatus />
              </button>
