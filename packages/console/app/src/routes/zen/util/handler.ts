...
import { and, Database, eq, isNull, lt, or, sql } from "@mindsparq-ai/console-core/drizzle/index.js"
import { KeyTable } from "@mindsparq-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@mindsparq-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@mindsparq-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@mindsparq-ai/console-core/util/date.js"
import { Identifier } from "@mindsparq-ai/console-core/identifier.js"
import { Billing } from "@mindsparq-ai/console-core/billing.js"
import { Actor } from "@mindsparq-ai/console-core/actor.js"
import { WorkspaceTable } from "@mindsparq-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@mindsparq-ai/console-core/model.js"
import { Subscription } from "@mindsparq-ai/console-core/subscription.js"
import { BlackData } from "@mindsparq-ai/console-core/black.js"
import { UserTable } from "@mindsparq-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@mindsparq-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@mindsparq-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@mindsparq-ai/console-core/lite.js"
import { Resource } from "@mindsparq-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-mindsparq-session") ?? ""
    const requestId = input.request.headers.get("x-mindsparq-request") ?? ""
    const ocClient = input.request.headers.get("x-mindsparq-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-mindsparq-request")
          headers.delete("x-mindsparq-session")
          headers.delete("x-mindsparq-project")
          headers.delete("x-mindsparq-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://mindsparq.ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://mindsparq.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://mindsparq.ai/workspace/${authInfo.workspaceID}/members`
