...
import compareVideo from "../../asset/lander/mindsparq-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/mindsparq-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="mindsparq:auth" content={loggedin() ? "true" : "false"} />
