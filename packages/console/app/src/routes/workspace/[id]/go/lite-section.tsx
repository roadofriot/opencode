...
import { Database, eq, and, isNull } from "@mindsparq-ai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@mindsparq-ai/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#mindsparq-go")} target="_blank" rel="noopener noreferrer">
