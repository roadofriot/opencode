...
- remove the public in-memory `@mindsparq-ai/llm` tool loop after replacing its
...
- decide whether to preserve deprecated `@mindsparq-ai/llm` orchestration exports
