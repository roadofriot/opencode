# MindSparQ AI Session Runtime

MindSparQ AI sessions preserve durable conversational history while assembling the runtime context an agent needs to act correctly in its current environment.
...
A temporary file created under MindSparQ AI's shared tool-output directory to retain complete output that was too large for Session history.
