...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/mindsparq/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/mindsparq...\n")
...
console.log("Fetching npm all-time downloads for mindsparq-ai...\n")
const npmDownloads = await fetchNpmDownloads("mindsparq-ai")
