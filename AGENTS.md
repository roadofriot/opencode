...
- If a namespace-style value is needed, import the module's own exported namespace by name, for example `import { Project } from "@mindsparq-ai/core/project"`, then reference `Project.ID`.
